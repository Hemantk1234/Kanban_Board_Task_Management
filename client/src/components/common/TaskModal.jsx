...
const TaskModal = (props) => {
  ...
  // State for task, title, and content
  ...
  useEffect(() => {
    // Set initial task, title, and content when props.task changes
    setTask(props.task);
  ...
  // Function to update CKEditor's height based on content
  ...
  // Function to delete modal class
  ...
  // Function to update the task content using CKEditor
